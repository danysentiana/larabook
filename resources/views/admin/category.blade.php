                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b">
                        <tr class="font-extrabold text-sm">
                            <th scope="col" class="p-1 text-center border-r">
                                No.
                            </th>
                            ...
                            <th scope="col" class="px-5 py-3 text-center border-l">
                                Action
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-5 py-4 text-center border-l">
                                {{-- <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline mr-2">Edit</a> --}}
                                        <!-- Modal toggle -->
                                <button data-modal-target="editModal_{{ $cat->id }}" data-modal-toggle="editModal_{{ $cat->id }}" class="text-black font-medium rounded-lg text-sm px-1 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                    Edit
                                </button>
